...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold">NoteMaster</span>
            </div>

            <div className="flex items-center gap-4">
              <Link
                to="/login"
                className="text-gray-400 hover:text-white px-4 py-2 rounded-lg hover:bg-gray-800/50 transition-all"
              >
                Sign in
              </Link>
              <Link
                to="/register"
                className="bg-gradient-to-r from-blue-600 to-purple-600 px-5 py-2 rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all transform hover:scale-105"
              >
                Try it free
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  to="/register"
                  className="group relative bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-4 rounded-xl font-semibold text-lg overflow-hidden transform hover:scale-105 transition-all"
                >
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Feature Card 1 */}
            <div className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-800 hover:border-blue-500/50 transition-all">
            ...
            {/* Feature Card 2 */}
            <div className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-800 hover:border-purple-500/50 transition-all">
            ...
            {/* Feature Card 3 */}
            <div className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-800 hover:border-green-500/50 transition-all">
              <div className="absolute top-4 right-4 text-4xl">🔍</div>
              <h3 className="text-2xl font-bold mb-3">
            ...
            {/* Feature Card 4 */}
            <div className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-800 hover:border-pink-500/50 transition-all">
              <div className="absolute top-4 right-4 text-4xl">⚡</div>
              <h3 className="text-2xl font-bold mb-3">Upload & forget</h3>
              <p className="text-gray-400 mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={idx}
                className="flex items-start gap-4 bg-gray-800/50 rounded-xl p-5 border border-gray-700/50 hover:border-gray-600 transition-all"
              >
                <span className="text-2xl">{item.emoji}</span>
                <p className="text-lg text-gray-300 flex-1">{item.reason}</p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 rounded-3xl border border-blue-500/20 p-12 text-center">
            ...
            <Link
              to="/register"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-green-600 to-blue-600 px-10 py-5 rounded-xl font-bold text-xl hover:shadow-2xl hover:shadow-green-500/50 transform hover:scale-105 transition-all"
            >
      ...
      {/* Final CTA - FOMO */}
      <section className="py-24 px-6 bg-gradient-to-t from-gray-900/50 to-transparent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            to="/register"
            className="inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all shadow-xl"
          >
            Alright, I'm in
